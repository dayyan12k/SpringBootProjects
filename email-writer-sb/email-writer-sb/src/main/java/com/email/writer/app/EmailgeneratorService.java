...
public class EmailgeneratorService {
    ...
    private String extractResponseContent(String response) {
        try{
            //convert the jason data to java object and vice versa
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("please generate the professional resoponse for the following email,dont add the subject line ");
